<template>
  <div class="login-container">
    <div class="login-logo">
      <img v-if="logo" :src="logo" class="login-logo-img">
    </div>
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <el-form-item class="login-btn-area">
...
.login-container {
  position:relative;
  background:linear-gradient(270deg, #1D3068 0%, #2B4696 100%);
// -ms-filter:"progid:DXImageTransform.Microsoft.gradient(GradientType=0,startColorstr=#aadbff,endColorstr=#ffffff)";//Ie8,9渐变
  .el-input {
...
.login-container {
  ...
  .svg-container {
    padding: rem(6) rem(5) rem(6) rem(15);// 6px 5px 6px 15px;
    color: $dark_gray;
  ...
  .title-container {
    ...
    .title {
      // font-size: 26px;
      // color: $light_gray;
      margin: rem(60) auto rem(53) auto;
      text-align: center;
      font-family: SourceHanSansCN-Regular;
      font-size: rem(30);
      color: #FFFFFF;
